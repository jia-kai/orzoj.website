...
/*
 * $File: faq.php
 * $Date: Wed Nov 10 18:48:15 2010 +0800
 */
/**
...
$faq = array(
	...
	__('If I chose to share my code to everybody, what if they see my code during the contest?') => __('Don\'t worry, the visibility of code in the contest is determined by contest rules. In most type of contests(like OI, ACM, etc.), the contest rule will forbid others from seeing your code. When the contest is finished, your code in the contest will be visible to others again.')
);
$cnt = 0;
echo '<ol>';
foreach ($faq as $Q => $A)
