...
/*
 * $File: faq.php
 * $Date: Wed Nov 10 15:59:29 2010 +0800
 */
/**
...
$faq = array(
	...
	__('Why should I share my code with others, for in many other Online Judges, they do not suppose to do so?') => __('We think the "Open Source" idea should spread to everyone here. Let you friends see your work will help them a lot, and you can get new thoughts via reading others code. Many great works is achieved by open source to people all over the world, and they helped improve it(e.g Linux). We hope everyone here share your code to others, and that will make a great learning environment.'),
	__('I\'m not going to share my code, how can I close this function?') => __('We are so sorry to hear that, but we respect your dicision. You can determine users in some certain groups see your code, and you can just select `Nobody`.'),
